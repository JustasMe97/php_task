...
if(mysqli_num_rows($result)>0)
{
    ...
    echo '<div class="fw bold mb-2">'.mysqli_num_rows($result).' rezultatų(-ai)</div>';
    $output='';
    while($row=mysqli_fetch_object($result))
	{
        ...
        <div type="button" class"btn btn-link reply" id="'.$row->id.'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-reply" viewBox="0 0 16 16">
